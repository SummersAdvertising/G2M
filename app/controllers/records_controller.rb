  ...
  def edit
    ...
    when "admin"
      ...
      @understandings = {"Q1" => "難管的員工，只是想做得更好，才會帶自己的電腦來工作，如果您改用 Windows 8.1，便能了解新的工作方式有多迷人　了解更多 Windows 8.1 >>", 
                         ...
                         "Q3" => "不拘小節的員工，有些天份與不拘小節是綁在一起的，例如創造力！公司對於資料的保密，要利用嚴謹的規則來取代限制，如強制將每一支使用的隨身碟都加密　了解更多 Windows 8.1 的加密功能 >>", 
                         "Q4" => "面對花俏的員工，您可以仔細觀察他們是如何花悄的工作，其中的行動工作能力或許是公司下一步競爭力的良方呢　了解更多 Windows 平板 >>", 
                         "Q5" => "質疑老闆判斷的員工，俗話說在組織內唱反調的員工才難得，當您把更直接的證據拿出來時，也才能讓組織真正學到您的經驗與知識　了解更多 Office 2013 的 PowerView >>", 
                         "Q6" => "關於上班也在 FB 的員工，說真的是有不少在浪費上班時間，但如果能讓員工透過 FB 更了解客戶，相信對業務也是有很大幫助的　了解更多 Windows 8.1 動態磚>>"
                        }
