  ...
  def edit
    ...
    when "admin"
      @resolutions = {"Q1_title" => "難管的員工 ──", "Q1_sub" => "公司比較優秀的員工都用自己的電腦工作，資料檔案無法掌控，真可怕", "Q1_detail" => "親愛的老闆，員工自己帶電腦原因不外乎：平板、觸控、雲端整合，這些也是Windows 8.1 的優點，如果將公司電腦升級，相信可以滿足員工需求，也能取回資料掌控權。", 
                      ...
                      "Q2_title" => "善變的員工──", "Q2_sub" => "員工一季換一支手機，說這樣才跟得上時代，不過我總覺得東西好好的還沒壞，就不用換", "Q2_detail" => "親愛的老闆，東西有沒有壞並不是好的汰換標準，能不能趕上現代的工作效率更是重要，比方說 Windows XP 終止支援就代表那台電腦效能降低、不堪用了（了解風險請看這裡）。", 
      ...
      @understandings = {"Q1" => "難管的員工，只是想做得更好，才會帶自己的電腦來工作，如果您改用 Windows 8.1，便能了解新的工作方式有多迷人　了解更多 Windows 8.1 >>", 
                         "Q2" => "善變的員工中，有相當多人是以研究新舊產品間的創新為己任，如果公司想做科技投資，這些人是很好的顧問，也可以請他們來研究繼續使用 Windows XP 的風險　了解更多 Windows XP 風險 >>", 
                         "Q3" => "3.  不拘小節的員工，有些天份與不拘小節是綁在一起的，例如創造力！公司對於資料的保密，要利用嚴謹的規則來取代限制，如強制將每一支使用的隨身碟都加密　了解更多 Windows 8.1 的加密功能 >>", 
                         "Q4" => "4.  面對花俏的員工，您可以仔細觀察他們是如何花悄的工作，其中的行動工作能力或許是公司下一步競爭力的良方呢　了解更多 Windows 平板 >>", 
                         "Q5" => "5.  質疑老闆判斷的員工，俗話說在組織內唱反調的員工才難得，當您把更直接的證據拿出來時，也才能讓組織真正學到您的經驗與知識　了解更多 Office 2013 的 PowerView >>", 
                         "Q6" => "6.  關於上班也在 FB 的員工，說真的是有不少在浪費上班時間，但如果能讓員工透過 FB 更了解客戶，相信對業務也是有很大幫助的　了解更多 Windows 8.1 動態磚>>"
                        }
    ...
    when "worker"
      ...
      @understandings = {"Q1" => "老闆堅持電腦壞了才能換，對很多白手起家的老闆是合理的想法，要改變他們需依循「身教重於言教」的原則，您不妨嘗試自帶先進的電腦工作，改善自己的產能，順便教導老闆新科技的價值　了解更多 Windows 8.1 >>", 
                         "Q2" => "老闆的生活比工作先進，其實這樣的老闆遠較「生活比工作落後」的老闆好多了，只要讓他們了解 Windows 平板對工作的幫助，或許明天就配一台給您了　了解更多 Windows 平板 >>", 
                         "Q3" => "老闆疑神疑鬼時，就要直接請他們來看臉書上客戶的動態，但如果您太常上 FB 從事自己的社交活動，請自重　了解更多 Windows 8.1 動態磚>>", 
                         "Q4" => "老闆確實是需要開會的，只能請他們儘量利用科技來開會，並且提升自己的行動工作能力　了解更多 Windows 平板 >>、了解更多 Office 365 >>", 
                         "Q5" => "要幫助不信任新科技的老闆，要善用「事件」，比如新聞報導或調查報告，讓老闆了解老舊設備的風險　了解更多 Windows XP 風險 >>", 
                         "Q6" => "老闆喜歡喊口號創新？難免啦，畢竟真的創新難為，但工作不只是為了公司，也是為了自己，投資自己創新所需的一切，才是真正的職場晉升之道　了解更多 Windows 8.1 的創新之處>>"}
    end
