...
class RecordsController < ApplicationController
  ...
  def edit
    ...
    when "owner", "manager"
      @resolutions = {
                      ...
                      "Q4_title" => "花俏的員工──", "Q4_sub" => "現在的員工老是想要「時尚」「個人風格」的辦公設備，都不考慮對工作是否實用", "Q4_detail" => "親愛的老闆，其實時尚及個人風格，代表的是一種工作方式的進步，比如變形平板不論在桌上工作，或帶出門展示，都比傳統筆電更靈活方便（請看這支影片），中看更中用。", 
      ...
      @understandings = {
                         "Q1" => "難管的員工，只是想做得更好，才會帶自己的電腦來工作，如果您改用 Windows 8.1，便能了解新的工作方式有多迷人　<a href='#'>了解更多 Windows 8.1 >></a>", 
                         "Q2" => "善變的員工中，有相當多人是以研究新舊產品間的創新為己任，如果公司想做科技投資，這些人是很好的顧問，也可以請他們來研究繼續使用 Windows XP 的風險　<a href='#'>了解更多 Windows XP 風險 >></a>", 
                         "Q3" => "不拘小節的員工，有些天份與不拘小節是綁在一起的，例如創造力！公司對於資料的保密，要利用嚴謹的規則來取代限制，如強制將每一支使用的隨身碟都加密　<a href='#'>了解更多 Windows 8.1 的加密功能 >></a>", 
                         "Q4" => "面對花俏的員工，您可以仔細觀察他們是如何花悄的工作，其中的行動工作能力或許是公司下一步競爭力的良方呢　<a href='#'>了解更多 Windows 平板 >></a>", 
                         "Q5" => "質疑老闆判斷的員工，俗話說在組織內唱反調的員工才難得，當您把更直接的證據拿出來時，也才能讓組織真正學到您的經驗與知識　<a href='#'>了解更多 Office 2013 的 PowerView >></a>", 
                         "Q6" => "關於上班也在 FB 的員工，說真的是有不少在浪費上班時間，但如果能讓員工透過 FB 更了解客戶，相信對業務也是有很大幫助的　<a href='#'>了解更多 Windows 8.1 動態磚>></a>"
                        }
    ...
    when "worker"
      ...
      @understandings = {
                         "Q1" => "老闆堅持電腦壞了才能換，對很多白手起家的老闆是合理的想法，要改變他們需依循「身教重於言教」的原則，您不妨嘗試自帶先進的電腦工作，改善自己的產能，順便教導老闆新科技的價值　<a href='#'>了解更多 Windows 8.1 >></a>", 
                         "Q2" => "老闆的生活比工作先進，其實這樣的老闆遠較「生活比工作落後」的老闆好多了，只要讓他們了解 Windows 平板對工作的幫助，或許明天就配一台給您了　<a href='#'>了解更多 Windows 平板 >></a>", 
                         "Q3" => "老闆疑神疑鬼時，就要直接請他們來看臉書上客戶的動態，但如果您太常上 FB 從事自己的社交活動，請自重　了解更多 Windows 8.1 動態磚>></a>", 
                         "Q4" => "老闆確實是需要開會的，只能請他們儘量利用科技來開會，並且提升自己的行動工作能力　<a href='#'>了解更多 Windows 平板 >></a>、<a href='#'>了解更多 Office 365 >></a>", 
                         "Q5" => "要幫助不信任新科技的老闆，要善用「事件」，比如新聞報導或調查報告，讓老闆了解老舊設備的風險　<a href='#'>了解更多 Windows XP 風險 >></a>", 
                         "Q6" => "老闆喜歡喊口號創新？難免啦，畢竟真的創新難為，但工作不只是為了公司，也是為了自己，投資自己創新所需的一切，才是真正的職場晉升之道　<a href='#'>了解更多 Windows 8.1 的創新之處>></a>"
                        }
    end
  ...
  def edit_for_iframe
    ...
    when "owner", "manager"
      ...
      @understandings = {"Q1" => "難管的員工，只是想做得更好，才會帶自己的電腦來工作，如果您改用 Windows 8.1，便能了解新的工作方式有多迷人　<a href='#'>了解更多 Windows 8.1 >></a>", 
                         "Q2" => "善變的員工中，有相當多人是以研究新舊產品間的創新為己任，如果公司想做科技投資，這些人是很好的顧問，也可以請他們來研究繼續使用 Windows XP 的風險　<a href='#'>了解更多 Windows XP 風險 >></a>", 
                         "Q3" => "不拘小節的員工，有些天份與不拘小節是綁在一起的，例如創造力！公司對於資料的保密，要利用嚴謹的規則來取代限制，如強制將每一支使用的隨身碟都加密　<a href='#'>了解更多 Windows 8.1 的加密功能 >></a>", 
                         "Q4" => "面對花俏的員工，您可以仔細觀察他們是如何花悄的工作，其中的行動工作能力或許是公司下一步競爭力的良方呢　<a href='#'>了解更多 Windows 平板 >></a>", 
                         "Q5" => "質疑老闆判斷的員工，俗話說在組織內唱反調的員工才難得，當您把更直接的證據拿出來時，也才能讓組織真正學到您的經驗與知識　<a href='#'>了解更多 Office 2013 的 PowerView >></a>", 
    ...
    when "worker"
      @resolutions = {"Q1_title" => "老闆堅持電腦壞了才能換──", "Q1_sub" => "大家的電腦都好慢，且職人雜誌的 e 化工作效率提升術，都跟我無關，因為公司電腦太過老舊", "Q1_detail" => "路不轉人轉，您可以帶自己的電腦工作，不論平板或電腦，只要是跑 Windows 8.1，就能與流行的雲端、觸控接軌，還可藉此刺激老闆幫公司電腦升級。", 
                      "Q1_1_sub" => "請問您的公司是否還在使用 Windows XP？",
                      "Q1_2_sub" => "請問您是否自帶電腦／平板上班？",
                      "Q2_title" => "老闆的生活比工作先進──", "Q2_sub" => "老闆擁有高級的平板或智慧手機，但只是拿來娛樂用", "Q2_detail" => "確實，很多老闆並不善於在工作上使用新工具，您可以推薦老闆使用 Windows平板，當他發現平板也能跑 Office 處理商務時，或許也會為員工更新設備，縮短公司數位落差。", 
                      "Q3_title" => "老闆就是疑神疑鬼──", "Q3_sub" => "看到我們上社群網站就覺得我們在摸魚，可是我們需要關注客戶動態啊！", "Q3_detail" => "Windows 8.1 動態磚讓您隨時看見客戶最新社群訊息，不必特別進入社群網站，治好老闆疑心病。", 
      ...
      @understandings = {"Q1" => "老闆堅持電腦壞了才能換，對很多白手起家的老闆是合理的想法，要改變他們需依循「身教重於言教」的原則，您不妨嘗試自帶先進的電腦工作，改善自己的產能，順便教導老闆新科技的價值　<a href='#'>了解更多 Windows 8.1 >></a>", 
                         "Q2" => "老闆的生活比工作先進，其實這樣的老闆遠較「生活比工作落後」的老闆好多了，只要讓他們了解 Windows 平板對工作的幫助，或許明天就配一台給您了　<a href='#'>了解更多 Windows 平板 >></a>", 
                         "Q3" => "老闆疑神疑鬼時，就要直接請他們來看臉書上客戶的動態，但如果您太常上 FB 從事自己的社交活動，請自重　了解更多 Windows 8.1 動態磚>></a>", 
                         "Q4" => "老闆確實是需要開會的，只能請他們儘量利用科技來開會，並且提升自己的行動工作能力　<a href='#'>了解更多 Windows 平板 >></a>、<a href='#'>了解更多 Office 365 >></a>", 
                         "Q5" => "要幫助不信任新科技的老闆，要善用「事件」，比如新聞報導或調查報告，讓老闆了解老舊設備的風險　<a href='#'>了解更多 Windows XP 風險 >></a>", 
