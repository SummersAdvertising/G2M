class Signup < ActiveRecord::Base
  ...
  validates :company, :email, :having_pc, :name, :office_versions, :pc_os, :tel, :title, :update_need, :industry, :having_mobile_device, :bring_pc_to_work, :company_mobile_device, :presence => true
